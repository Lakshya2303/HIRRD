...
const JobPosting = () => {
  ...
  if (!isLoaded || loadingCompanies) return <BarLoader className='mb-4' width={"100%"} color='#36d7b7'/>
  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4 p-4 pb-0">
          ...
          <Controller 
            ...
            render={({ field }) => (
              <Select value={field.value} onValueChange={field.onChange}>
                ...
                <SelectContent>
                  <SelectGroup>
                    {companies?.length && companies.map(({ name, id }) => {
                      return (
        ...
        <Button type="submit" variant="blue" size="lg" className="mt-2 mb-4">Post</Button>
      </form>
    </div>
  )
}
